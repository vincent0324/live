...
var Display = function () {
    ...
    _createClass(Display, [{
        ...
        value: function bindEvent() {
            var context = this;
            var displaySwiper = void 0;

            (0, _jquery2.default)(document).on('click', '.photo-single img', function () {
                var url = (0, _jquery2.default)(this).data('url');

                (0, _jquery2.default)('.display-single .wrap').html('<img src="' + url + '">');
                (0, _jquery2.default)('.display-single').fadeIn();
            });

            (0, _jquery2.default)(document).on('click', '.display-single', function () {
                (0, _jquery2.default)('.display-single').fadeOut();
                (0, _jquery2.default)('.display-single .wrap').html('');
            });

            (0, _jquery2.default)(document).on('click', '.photo-img', function () {
                var images = (0, _jquery2.default)(this).parents('.stream-item-photo').find('.photo-img');
                var imagesLength = images.length;
                var index = images.index(this);
                var swiperHtml = '';

                for (var i = 0; i < imagesLength; i++) {
                    var url = images.eq(i).data('url') || '';

                    swiperHtml += '<div class="display-slide"><img src="' + url + '"></div>';
                }

                (0, _jquery2.default)('.display-wrapper').html(swiperHtml);
                (0, _jquery2.default)('.display').fadeIn();
                (0, _jquery2.default)('.display-pages-sum').html(imagesLength);
                (0, _jquery2.default)('.display-pages-current').html(index + 1);

                displaySwiper = new _swiper2.default('.display-container', {
                    loop: false,
                    grabCursor: true,
                    ...
                    onTouchEnd: function onTouchEnd(swiper) {
                        (0, _jquery2.default)('.display-pages-current').html(displaySwiper.activeIndex + 1);
                    }
                });
            });

            (0, _jquery2.default)(document).on('click', '.display', function () {
                (0, _jquery2.default)('.display').fadeOut();
                (0, _jquery2.default)('.display-wrapper').html('');
                (0, _jquery2.default)('.display-pages-sum').html('');
                (0, _jquery2.default)('.display-pages-current').html('');
    ...
    _createClass(Tab, [{
        ...
        value: function bindEvent() {
            ...
            (0, _jquery2.default)(window).on('scroll', function () {
                var tabHeight = (0, _jquery2.default)('.live-tab-button').offset().top;
                var docTop = (0, _jquery2.default)(document).scrollTop();

                if (tabHeight < docTop) {
                    (0, _jquery2.default)('.live-tab-holder').addClass('fixed');
                } else {
                    (0, _jquery2.default)('.live-tab-holder').removeClass('fixed');
                }
            });

            (0, _jquery2.default)('.live-tab-holder a').on('click', function () {
